<?php 
    ...
    if(isset($_POST['reset']))
    {
        ...
        if(!empty($password))
        {
            ...
            {
                $errors['reset'] = "Password must be between in 5 - 20 character";
            }
            else
            {
	...
	<div class="wrapper">
		...
		<div class="sign-in">
            <?php if(isset($_GET['success'])): ?>
                <div class="success-message">Your password has been change, now you can  <a href="http://localhost:81/login-system">Login</a></div>
            <?php else: ?>
