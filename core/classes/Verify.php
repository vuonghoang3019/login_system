...
class Verify
    {
        ...
        public function sendToMail($email, $message, $subject)
		{
			...
			if(!empty($email)){
				$mail->From     = "vuongmau199@gmail.com";
				$mail->FromName = "hello";
				$mail->addReplyTo('vuongmau199@gmail.com');
		...
		public function senToPhone($number, $message)
		{
			$username = "vuongmau199@gmail.com";
			$apiHash = "Key API HERE";
			$apiUrl = "LINK URL";
			$test = 1;
